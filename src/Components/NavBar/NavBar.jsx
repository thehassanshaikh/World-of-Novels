  ...
  return (
    <div className="navBar flex justify-between items-center bg-[#fcc1bd] shadow-lg p-4">
      ...
      <div className='logo text-center flex md:order-1'>
        <div className='cursor-pointer'><img className='w-48' src={logo1} alt=""></img></div>
      ...
      <div className="SItem ">Sell+</div>
       ...
       <div className='cart text-center md:order-3 flex inset-12'>
        ...
        <img className="w-6 h-6 mr-4 cursor-pointer text-white" src={cart} alt=""></img>
        <img className="w-6 h-6 mr-4 cursor-pointer text-white" src={usericon} alt=""></img>
          </div>
