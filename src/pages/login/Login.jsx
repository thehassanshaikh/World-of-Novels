...
function Login() {
  ...
  const { googleSignIn, user, setState, emailPasswordSignIn, state } =
    UserAuth();
  ...
  useEffect(() => {
    if (state.email !== "" && state.password !== "") emailPasswordSignIn();
  }, [state]);
      ...
      >
        ...
        <div className="bg-[#fcc1bd] flex rounded-2xl shadow-2xl  max-w-3xl p-3">
          ...
          <div className="sm:w-1/2 px-16 py-4 rounded-2xl bg-[#b0d9d3]">
            ...
            <p className="text-sm mt-4 text-[#0B1354]">log in your Account</p>
            ...
            <div className="w-full flex items-center justify-center relative py-6">
              ...
              <p className="text-lg absolute text[#0B1354] bg-[#b0d9d3] px-1">
                or
              </p>
            </div>
            ...
            <button
              onClick={signin}
              className="bg-white border py-2 w-full rounded-xl mt-2 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#0B1354]"
            >
              <svg
                className="mr-3"
                xmlns="http://www.w3.org/2000/svg"
