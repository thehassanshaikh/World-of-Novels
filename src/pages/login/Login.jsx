      ...
      <section className='min-h-screen flex items-center justify-center' style={{ backgroundImage: `url(${mintbackground})` }}>
        ...
        <div className='sm:w-1/2 px-16 py-4 rounded-2xl bg-[#f0edf4]'>
         ...
         <form className='flex flex-col gap-4'>
          ...
          <button type='submit' className='bg-[#6b9eb0] text-[#00372e] hover:bg-[#00372e] hover:scale-90 rounded-xl py-2 hover:text-white'>Login</button>
         </form>
         ...
         <button className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#00372e]">
